...
def test_policy_check_rejects_ambiguous_content_sources(mock_claude_workspace: ContainerLike) -> None:
...
def test_missing_supervisor_enabling_actions_fail(mock_claude_workspace: ContainerLike) -> None:
...
def test_direct_policy_check_accepts_the_shared_bundle_vocabulary(mock_claude_workspace: ContainerLike) -> None:
