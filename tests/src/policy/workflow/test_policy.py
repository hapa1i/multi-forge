"""Tests for forge.policy.workflow.policy."""
...
from forge.policy.workflow.config import BranchConfig, CheckerConfig, WorkflowConfig
...
class TestWorkflowPolicyEvaluate:
    @patch("forge.policy.workflow.policy.tag_action")
