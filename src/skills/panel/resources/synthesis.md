...
### Critical
- **[Issue]** (found by: gpt-6-astra, gemini-3.1-pro-preview)
...
| ---------------------- | ------------ | ------------------------------------------ |
| gpt-6-astra            | Logic errors | Edge cases, off-by-one, null handling      |
...
- **[Issue]**: gpt-6-astra says X, gemini says Y
...
## Summary
- Models consulted: 3 (gpt-6-astra, gemini-3.1-pro-preview, claude-opus)
- Consensus issues: N
- Unique findings: N
