...
**Last updated**: 2026-07-31 (extension QA now removes one project runtime, proves sync does not resurrect it, and
restores the dual-runtime package set). Earlier 2026-07-30: extension QA now asserts schema-v3 runtime/module ownership,
the merged `hooks` module, and runtime-wide selection. Earlier 2026-07-26: model refresh: section 4 tier assertions now
