...
**Last updated**: 2026-08-08 (proxy QA now verifies that a refused adopted kill exits non-zero while retaining the
foreign process, registry row, and overlay). Earlier 2026-08-08: proxy/config QA added fail-closed degraded
