...
**Lane**: `doing/` -- 35 of 36 findings across 12 of 13 members shipped in PRs #164--#176. O036 remains parked in
`todo/` pending its fail-first execution gate. PR #169 (`ece999d4`) hardened O012 escalation and retention-status error
