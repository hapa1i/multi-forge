...
**Lane**: `doing/` -- 18 of 36 findings across 8 of 13 members shipped in PRs #164--#172. D031 is the sole active member
on `agent/exclude-interactive-usage-cost`; the remaining 17 findings across 4 members stay parked in `todo/`. PR #169
