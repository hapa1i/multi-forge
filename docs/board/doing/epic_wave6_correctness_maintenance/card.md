...
**Lane**: `doing/` -- 19 of 36 findings across 9 of 13 members shipped in PRs #164--#173. The D032/D041/O005/O031--O033
member is implemented and verified on `agent/align-cli-failure-surfaces`, pending independent review; the remaining 11
findings across 3 members stay parked in `todo/`. PR #169 (`ece999d4`) hardened O012 escalation and retention-status
error sanitization without adding a finding to this admission set.
