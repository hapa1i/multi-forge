...
**Lane**: `doing/` -- D020 is active on `agent/d020-inherited-forge-headers`; the other 11 members remain parked in
`todo/` behind their fail-first reproduction gates.
...
| 2     | D023, D028, O022                 | [`align_transfer_preflight_and_cli_contract`](../../todo/align_transfer_preflight_and_cli_contract/card.md) | transfer source/depth/reattach semantics      |
