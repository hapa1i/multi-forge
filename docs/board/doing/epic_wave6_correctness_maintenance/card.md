...
**Lane**: `doing/` -- 35 of 36 findings across 12 of 13 members shipped in PRs #164--#176. O036 is
implementation-complete and pending independent review on `agent/harden-walkthrough-sandbox-provenance`. PR #169
...
| 12    | O011, O017, O021, O023, O029--30 | [`preserve_session_launch_preconditions`](../../done/preserve_session_launch_preconditions/card.md)         | launch preflight, rollback, and fail-open     |
...
operator read paths, and session launch safety. O036 is independently active because it changes a bundled shell safety
