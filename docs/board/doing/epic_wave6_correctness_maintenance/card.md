...
**Lane**: `doing/` -- 8 of 34 findings across 4 of 12 members shipped in PRs #164--#167; no member is active while the
other 8 remain parked in `todo/` behind their fail-first reproduction gates.
