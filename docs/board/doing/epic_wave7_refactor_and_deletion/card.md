...
**Lane**: `doing/` -- orders 1--19 shipped independently in PRs #178--#184, #186--#188, and #190--#198; order 20 is
active and 15 members remain parked. The bounded
...
| 20    | O092 search      | [`wire_transcript_reindex_guard`](../../doing/wire_transcript_reindex_guard/card.md)                    | metadata-unchanged snapshot avoidance                |
