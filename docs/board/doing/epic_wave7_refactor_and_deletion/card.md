...
**Lane**: `doing/` -- orders 1--6 shipped independently in PRs #178--#183; no member is active while the order-6
...
| 7     | O098, O092       | [`remove_verified_internal_residue`](../../todo/remove_verified_internal_residue/card.md)               | verified session metadata and cap-state residue      |
