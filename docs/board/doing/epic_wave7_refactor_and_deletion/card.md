...
**Lane**: `doing/` -- orders 1--13 shipped independently in PRs #178--#184, #186--#188, and #190--#192; order 14
[`replace_unsafe_index_test_fixtures`](../replace_unsafe_index_test_fixtures/card.md) is active from `74b364d2`, with 21
...
| 22    | O092 script      | [`simplify_count_tokens_mode_selector`](../../todo/simplify_count_tokens_mode_selector/card.md)         | explicit local/provider selector                     |
| 23    | O053             | [`share_codex_thread_index_sync`](../../todo/share_codex_thread_index_sync/card.md)                     | one adoption-safe durable index writer               |
