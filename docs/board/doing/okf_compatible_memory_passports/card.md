...
**Status**: Reopened (`doing/`) on 2026-07-15 after post-closeout review found delimiter-selection and reserved-path
gaps in AT-08/AT-14. The original implementation is `fae54345`; remediation is tracked in [checklist.md](checklist.md).
...
| AT-14 | Reserved paths have no side effects      | exact/mixed-case logical or resolved `index.md`/`log.md` official and custom-shadow targets                                    | authoring fails before either write; scanners skip hand-authored reserved shadow targets; relevant files remain unchanged                         | `tests/src/cli/test_memory.py`, `tests/src/session/test_project_memory.py`                                                                                                                                                                 |
