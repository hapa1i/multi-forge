...
8 Batch 1 is active on `agent/wave8-batch-1` with orders 9--10 and one external accepted follow-up; orders 11--19 remain
parked under the recorded batch plan.
