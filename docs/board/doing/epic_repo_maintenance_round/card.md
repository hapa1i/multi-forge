...
members shipped in PRs #164--#175; the remaining 7 findings across two members remain parked behind their
...
D054/D055 into a shipped Wave 6 member. D056 is recorded separately and awaits its own execution gate; the remaining two
members stay gated on fail-first execution-branch reproductions.
