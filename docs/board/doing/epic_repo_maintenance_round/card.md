...
findings across 35 implementation members; orders 1--7 shipped independently in PRs #178--#184, and the other 28 remain
parked while [`correct_post_merge_review_findings`](../correct_post_merge_review_findings/card.md) addresses five
verified post-merge defects. The user admitted O098 and the verified cap-state subset of O092 as one bounded,
