...
findings across 34 implementation members; orders 1--5 shipped independently in PRs #178--#182, while the other 29
remain parked and no member is active during closeout. D056 and the other separately gated Wave 6 rows remain outside
that admission.
