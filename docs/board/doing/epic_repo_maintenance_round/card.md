...
shipped, and O014/O026 are the sole active member. Remaining Wave 6/7 rows require their separate entry-condition
checks.
...
34 live rows into [`epic_wave6_correctness_maintenance`](../epic_wave6_correctness_maintenance/card.md), where six
findings across the first three members shipped in PRs #164--#166, O014/O026 are active, and the remaining eight members
