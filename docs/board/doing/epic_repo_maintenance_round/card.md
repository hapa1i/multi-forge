...
orders 9--10 and the external Batch 1 Stop follow-up shipped in PR #225. Batch 2 orders 11--12 are active on
`agent/wave8-batch-2`; orders 13--19 remain parked under the recorded batch plan.
