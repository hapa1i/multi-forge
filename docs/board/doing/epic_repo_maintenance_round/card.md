...
findings across 34 implementation members; orders 1--3 shipped independently in PRs #178--#180, order-4 O066/O092 is
active on `refactor/unify-git-root-discovery`, and the other 30 remain parked. D056 and the other separately gated Wave
