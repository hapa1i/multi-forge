...
members shipped in PRs #164--#176; O036 remains parked behind its entry-condition checks. PR #169 added bounded O012 and
...
D054/D055 into a shipped Wave 6 member. D056 is recorded separately and awaits its own execution gate; O036 remains
gated on a fail-first execution-branch reproduction.
