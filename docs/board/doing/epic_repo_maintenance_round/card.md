...
orders 9--10 and the external Batch 1 Stop follow-up shipped in PR #225; Batch 2 orders 11--12 shipped in PR #226.
Orders 13--19 remain parked under the recorded batch plan.
