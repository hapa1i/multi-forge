...
2 closed after PR #132, and the verified Wave 3 session/durable-state members are accepted and parked for sequential
execution.
...
#130–#132. Wave 3 is coordinated by the parked
[`epic_session_durable_state_safety`](../../todo/epic_session_durable_state_safety/card.md); all eight findings were
reproduced on `dc963a7c`, and no member is active yet.
...
| 3    | D011            | [`preserve_unreadable_json_state_classification`](../../todo/preserve_unreadable_json_state_classification/card.md) |
| 3    | O006            | [`reject_non_object_manifest_confirmed`](../../todo/reject_non_object_manifest_confirmed/card.md)                   |
