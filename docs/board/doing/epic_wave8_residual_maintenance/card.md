...
Batch 1 Stop follow-up shipped in PR #225, and orders 11--19 remain parked.

**Current execution**: no member is active. Batch 1 shipped in PR #225 (`fd548c8e`), and its three cards closed
together. Batch 2 is next but remains parked until it is activated from the pushed Batch 1 closeout.
