...
**Slice 2 complete; next up is Slice 3.** Slice 2 review follow-ups are pinned in this checklist. The turn-window prefix
writer is in place with focused unit coverage, and `N=0` is pinned as a plain native-relocate no-op for manifest
purposes.
