...
- [x] Run focused Claude op, manifest-characterization, resume, fork, and relevant regression tests (222 passed).
- [x] Run `make test-unit` (9,248 passed, one skipped, 122 deselected) and `make test-regression` (923 passed).
