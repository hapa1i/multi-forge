...
**Lane**: `todo/` -- accepted and parked. No member is active; each member must satisfy its fail-first reproduction gate
...
| 7     | O013, O034                       | [`align_policy_routing_context`](../align_policy_routing_context/card.md)                           | policy routing/session selector consistency   |
| 8     | D031                             | [`exclude_interactive_usage_cost`](../exclude_interactive_usage_cost/card.md)                       | two-plane interactive exclusion               |
| 9     | D032, D041, O005, O031--O033     | [`align_cli_failure_surfaces`](../align_cli_failure_surfaces/card.md)                               | CLI exit, stream, editor, and status behavior |
| 10    | D034, D037, D038, O027           | [`harden_command_state_boundaries`](../harden_command_state_boundaries/card.md)                     | hook silence and strict durable-state reads   |
| 11    | O011, O017, O021, O023, O029--30 | [`preserve_session_launch_preconditions`](../preserve_session_launch_preconditions/card.md)         | launch preflight, rollback, and fail-open     |
| 12    | O036                             | [`harden_walkthrough_sandbox_provenance`](../harden_walkthrough_sandbox_provenance/card.md)         | sandbox provenance before code execution      |
