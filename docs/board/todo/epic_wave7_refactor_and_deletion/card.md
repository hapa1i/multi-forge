...
**Lane**: `todo/` -- accepted and fully sequenced, but no Wave 7 implementation branch or member is active.
...
| 2     | O044             | [`share_policy_activation_rules`](../share_policy_activation_rules/card.md)                     | shared validation, distinct state owners             |
...
| 4     | O066, O092       | [`unify_git_root_discovery`](../unify_git_root_discovery/card.md)                               | optional vs strict git-root contracts                |
| 5     | O065, O069       | [`centralize_install_path_authority`](../centralize_install_path_authority/card.md)             | lower-layer path and ownership policy                |
...
| 7     | O071             | [`remove_stale_dependencies`](../remove_stale_dependencies/card.md)                             | package metadata and clean-wheel proof               |
| 8     | O099 subset      | [`share_proxy_transport_test_fakes`](../share_proxy_transport_test_fakes/card.md)               | instance-safe proxy transport fixtures               |
| 9     | O073             | [`lock_walkthrough_state_parity`](../lock_walkthrough_state_parity/card.md)                     | self-contained skill copies with drift guards        |
| 10    | O047, O048, O092 | [`remove_obsolete_proxy_abstractions`](../remove_obsolete_proxy_abstractions/card.md)           | unreachable proxy types and factory diagnostics      |
| 11    | O049 config      | [`migrate_inert_config_fields`](../migrate_inert_config_fields/card.md)                         | first-release config deprecation only                |
| 12    | O049 manifest    | [`migrate_memory_intent_generated_file`](../migrate_memory_intent_generated_file/card.md)       | tolerant durable-manifest migration                  |
| 13    | O050 fixtures    | [`replace_unsafe_index_test_fixtures`](../replace_unsafe_index_test_fixtures/card.md)           | transaction-safe test state construction             |
| 14    | O050 API         | [`retire_unsafe_index_mutators`](../retire_unsafe_index_mutators/card.md)                       | zero-caller unsafe public mutators                   |
| 15    | O051             | [`replace_legacy_tier_inference`](../replace_legacy_tier_inference/card.md)                     | explicit tier/cache/auth-retry provenance            |
| 16    | O052             | [`remove_dead_session_context_retry`](../remove_dead_session_context_retry/card.md)             | session-context error classification                 |
| 17    | O092 session     | [`remove_dead_session_helpers`](../remove_dead_session_helpers/card.md)                         | verified internal session-only zero-callers          |
| 18    | O092 policy      | [`deprecate_supervisor_verdict_wrapper`](../deprecate_supervisor_verdict_wrapper/card.md)       | one-release re-export deprecation                    |
| 19    | O092 search      | [`wire_transcript_reindex_guard`](../wire_transcript_reindex_guard/card.md)                     | unchanged-snapshot index avoidance                   |
| 20    | O092, O096       | [`retire_test_only_settings_helpers`](../retire_test_only_settings_helpers/card.md)             | live settings merge/rollback coverage                |
| 21    | O092 script      | [`simplify_count_tokens_mode_selector`](../simplify_count_tokens_mode_selector/card.md)         | explicit local/provider selector                     |
| 22    | O053             | [`share_codex_thread_index_sync`](../share_codex_thread_index_sync/card.md)                     | one adoption-safe durable index writer               |
| 23    | O054             | [`unify_resume_routing_reference`](../unify_resume_routing_reference/card.md)                   | proxy-ID/template resume reference                   |
| 24    | O055             | [`reuse_claude_usage_measurement`](../reuse_claude_usage_measurement/card.md)                   | one proxied usage precedence rule                    |
| 25    | O056             | [`centralize_telemetry_jsonl_reads`](../centralize_telemetry_jsonl_reads/card.md)               | tolerant per-plane JSONL read scaffold               |
| 26    | O057, O095       | [`share_review_worker_preparation`](../share_review_worker_preparation/card.md)                 | review resource/worker input preparation             |
| 27    | O058             | [`unify_claude_session_state_context`](../unify_claude_session_state_context/card.md)           | manifest-to-store/worktree derivation                |
| 28    | O059             | [`share_transfer_rewind_rendering`](../share_transfer_rewind_rendering/card.md)                 | shared rendering primitives, distinct envelopes      |
| 29    | O067             | [`share_passthrough_sse_framing`](../share_passthrough_sse_framing/card.md)                     | common SSE framing, transport-specific merge         |
| 30    | O068             | [`extract_session_fork_preflight`](../extract_session_fork_preflight/card.md)                   | UI-free pre-mutation validation                      |
| 31    | O068, O096       | [`extract_session_fork_execution`](../extract_session_fork_execution/card.md)                   | mutation/rollback plan and thin Click adapter        |
| 32    | O069             | [`decompose_extension_install_transaction`](../decompose_extension_install_transaction/card.md) | ordered install fault and rollback phases            |
| 33    | O070             | [`extract_statusline_sources`](../extract_statusline_sources/card.md)                           | source facts and import direction                    |
| 34    | O070, O092       | [`extract_statusline_rendering`](../extract_statusline_rendering/card.md)                       | pure render/layout tail and process-local cache exit |
