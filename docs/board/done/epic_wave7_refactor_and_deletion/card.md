...
[`correct_search_index_fingerprint_race`](../correct_search_index_fingerprint_race/card.md) correction closed order 20's
post-merge snapshot race directly on `main` after PR #206 and before order 28. The bounded
[`correct_empty_tz_period_bounds`](../correct_empty_tz_period_bounds/card.md) correction shipped in PR #189 before order
11; the earlier [`correct_post_merge_review_findings`](../correct_post_merge_review_findings/card.md) member shipped in
PR #185.
...
every deletion follows the [`deletion_compatibility_contract`](../deletion_compatibility_contract/card.md).
...
| 12    | O049 config      | [`migrate_inert_config_fields`](../migrate_inert_config_fields/card.md)                         | first-release config deprecation only                |
...
| 14    | O050 fixtures    | [`replace_unsafe_index_test_fixtures`](../replace_unsafe_index_test_fixtures/card.md)           | transaction-safe test state construction             |
...
| 19    | O092 policy      | [`deprecate_supervisor_verdict_wrapper`](../deprecate_supervisor_verdict_wrapper/card.md)       | one-release re-export deprecation                    |
| 20    | O092 search      | [`wire_transcript_reindex_guard`](../wire_transcript_reindex_guard/card.md)                     | metadata-unchanged snapshot avoidance                |
| 21    | O092, O096       | [`retire_test_only_settings_helpers`](../retire_test_only_settings_helpers/card.md)             | live settings merge/rollback coverage                |
| 22    | O092 script      | [`simplify_count_tokens_mode_selector`](../simplify_count_tokens_mode_selector/card.md)         | explicit local/provider selector                     |
| 23    | O053             | [`share_codex_thread_index_sync`](../share_codex_thread_index_sync/card.md)                     | one adoption-safe durable index writer               |
| 24    | O054             | [`unify_resume_routing_reference`](../unify_resume_routing_reference/card.md)                   | proxy-ID/template resume reference                   |
| 25    | O055             | [`reuse_claude_usage_measurement`](../reuse_claude_usage_measurement/card.md)                   | one proxied usage precedence rule                    |
| 26    | O056             | [`centralize_telemetry_jsonl_reads`](../centralize_telemetry_jsonl_reads/card.md)               | tolerant per-plane JSONL read scaffold               |
| 27    | O057, O095       | [`share_review_worker_preparation`](../share_review_worker_preparation/card.md)                 | review resource/worker input preparation             |
| 28    | O058             | [`unify_claude_session_state_context`](../unify_claude_session_state_context/card.md)           | manifest-to-store/worktree derivation                |
| 29    | O059             | [`share_transfer_rewind_rendering`](../share_transfer_rewind_rendering/card.md)                 | shared rendering primitives, distinct envelopes      |
| 30    | O067             | [`share_passthrough_sse_framing`](../share_passthrough_sse_framing/card.md)                     | common SSE framing, transport-specific merge         |
| 31    | O068             | [`extract_session_fork_preflight`](../extract_session_fork_preflight/card.md)                   | UI-free pre-mutation validation                      |
| 32    | O068, O096       | [`extract_session_fork_execution`](../extract_session_fork_execution/card.md)                   | mutation/rollback plan and thin Click adapter        |
...
| 35    | O070, O092       | [`extract_statusline_rendering`](../extract_statusline_rendering/card.md)                       | pure render/layout tail and process-local cache exit |
...
This epic closed after all 35 live members shipped, the review ledger and parent links were synchronized, shipped
ownership was documented, and every required integration, package, and board-integrity check was recorded. Retired cards
are not shipped-member credit, and separately gated findings remain outside this admission.
