...
without adding a finding to this admission set.
...
| ----- | -------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| 1     | D020                             | [`strip_direct_child_forge_headers`](../strip_direct_child_forge_headers/card.md)                   | outbound correlation-header trust             |
...
| 5     | D029, O025                       | [`complete_proxy_instance_config_wiring`](../complete_proxy_instance_config_wiring/card.md)         | template-to-instance field preservation       |
...
| 8     | O013, O034                       | [`align_policy_routing_context`](../align_policy_routing_context/card.md)                           | policy routing/session selector consistency   |
| 9     | D031                             | [`exclude_interactive_usage_cost`](../exclude_interactive_usage_cost/card.md)                       | two-plane interactive exclusion               |
| 10    | D032, D041, O005, O031--O033     | [`align_cli_failure_surfaces`](../align_cli_failure_surfaces/card.md)                               | CLI exit, stream, editor, and status behavior |
...
| 13    | O036                             | [`harden_walkthrough_sandbox_provenance`](../harden_walkthrough_sandbox_provenance/card.md)         | sandbox provenance before code execution      |

The sequence started with isolated trust and transfer contracts, then process/proxy lifecycle, proxy request semantics,
operator read paths, and session launch safety. O036 ran last because it changed a bundled shell safety boundary and
required clean-package verification.
...
This bounded epic closed after all 36 live findings shipped independently, the review ledger pointed to each terminal
outcome, and documentation scope was verified. D056 and the remaining separately gated Wave 6/7 rows are not part of
this admission. The closeout does not affect Wave 5's closed 13-finding count.
