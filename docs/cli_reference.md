...
| `forge session adopt [conversation-id]` | Bind a Forge session to an existing native Claude conversation (`--name`, `--model`, `--yes`); bare lists unbound candidates. Run from its launch directory |
