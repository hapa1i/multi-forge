...
This resolves the proxy, healthchecks it, sets `ANTHROPIC_BASE_URL`, proxy-scoped `CLAUDE_CODE_ATTRIBUTION_HEADER=0`,
and `CLAUDE_CODE_AUTO_COMPACT_WINDOW`, and launches Claude.
