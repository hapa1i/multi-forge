...
forge session fork planner --worktree --supervise \
  --cascade --checker-model google/gemini-3.8-flash --checker-provider openrouter

# Same knobs on session start
forge session start executor --supervise planner --cascade --checker-model google/gemini-3.8-flash
```
