...
- Sets `CLAUDE_CODE_ATTRIBUTION_HEADER=0` for this proxy-routed Claude process only, preserving third-party prompt
  caching without leaking the setting into direct Anthropic launches
