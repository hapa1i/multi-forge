...
exposes the displaced models (Fable 5, Opus 4.8, Opus 4.6, Sonnet 4.6) as alternatives for explicit session pins. You
do not need separate proxies just to compare Claude versions:
